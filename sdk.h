...
public:
	...
	void K2_DrawTextCustomize(ue::classes::UObject* RenderFont, ue::FString RenderText, Vector2 ScreenPosition, Vector2 Scale, ue::FLinearColor RenderColor, ue::FLinearColor ShadowColor, Vector2 ShadowOffset, bool bCentreX, bool bCentreY, bool bOutlined, ue::FLinearColor OutlineColor)
	{
		if (!sdkUssage->isValidPointer((uintptr_t)this)) return;

		struct
		{
			ue::classes::UObject* RenderFont;
			ue::FString                                     RenderText;
			Vector2                                   ScreenPosition;
			Vector2                                   Scale;
			ue::FLinearColor                                RenderColor;
			float                                              Kerning;
			ue::FLinearColor                                ShadowColor;
			Vector2                                   ShadowOffset;
			bool                                               bCentreX;
			bool                                               bCentreY;
			bool                                               bOutlined;
			ue::FLinearColor                                OutlineColor;
		} params;
...
public:
	...
	{
		if (!sdkUssage->isValidPointer((uintptr_t)this)) return {};
		return *(ue::FText*)((uintptr_t)this + 0x90); //FortItemDefinition::DisplayName
	}

	EFortItemTier Tier()
	{
		return *(EFortItemTier*)((uintptr_t)this + 0x73); //FortItemDefinition::Tier
	}
...
public:
	...
	{
		if (!sdkUssage->isValidPointer((uintptr_t)this)) return 0;
		return (AFortItemDefinition*)(*(uintptr_t*)(this + ue::cached::offsets::WeaponData)); //FortWeapon::WeaponData 0x3F0
	}
	...
	void RapidFire()
	{
		...
		*(float*)((uintptr_t)this + ue::cached::offsets::LastFireTime) = 0;
		*(float*)((uintptr_t)this + ue::cached::offsets::LastFireTimeVerified) = 0;
	}
	...
	uintptr_t GetCurrentReticleSpreadMultiplier()
	{
		static ue::classes::UObject* fn = NULL;
		if (!fn)
			fn = (ue::classes::UObject*)find::FindObject((L"FortniteGame.FortWeaponRanged.GetCurrentReticleSpreadMultiplier"));
		if (!fn) Beep(500, 500);
	...
	uintptr_t GetWeaponStats()
	{
		...
		auto GetWeaponStats = reinterpret_cast<bool(__fastcall*)(uintptr_t, uintptr_t*)>(ue::cached::signatures::GetWeaponStats);
		GetWeaponStats((uintptr_t)this, &Output);
	...
	float GetMaxFiringRate()
	{
		static ue::classes::UObject* fn = NULL;
		if (!fn)
			fn = (ue::classes::UObject*)find::FindObject((L"FortniteGame.FortWeapon.GetFiringRate"));
...
public:
	...
	{
		if (!sdkUssage->isValidPointer((uintptr_t)this)) return 0;
		return *(uintptr_t*)(this + ue::cached::offsets::TeamIndex); // FortPlayerStateAthena::TeamIndex 0x1098
	}
...
public:
	...
	{
		if (!sdkUssage->isValidPointer((uintptr_t)this)) return 0;
		return (AFortItemDefinition*)(*(uintptr_t*)((uintptr_t)this + (0x330 + 0x18)));
	}
	...
	{
		if (!sdkUssage->isValidPointer((uintptr_t)this)) return 0;
		return *(char*)((uintptr_t)this + ue::cached::offsets::bIsDying);
	}

	char bAlreadySearched()
	{
		if (!sdkUssage->isValidPointer((uintptr_t)this)) return 0;
		return *(char*)((uintptr_t)this + ue::cached::offsets::bAlreadySearched);
	}
	...
	BOOL K2_DestroyActor()
	{
		...
		sdkUssage->ProcessEvent((uintptr_t)this, ue::cached::objects::K2_DestroyActor, &params);
...
public:
	...
	{
		if (!sdkUssage->isValidPointer((uintptr_t)this)) return 0;
		return (AFortPawn*)(*(uintptr_t*)((uintptr_t)this + 0x330)); //PlayerController::AcknowledgedPawn
	}

	APlayerCameraManager* PlayerCameraManager()
	{
		if (!sdkUssage->isValidPointer((uintptr_t)this)) return 0;
		return (APlayerCameraManager*)(*(uintptr_t*)(this + ue::cached::offsets::PlayerCameraManager)); //PlayerController::PlayerCameraManager
	}
	...
	BOOL LineOfSightTo(AFortPawn* Actor)
	{
		if (!sdkUssage->isValidPointer((uintptr_t)this)) return 0;

		auto LOSTo = reinterpret_cast<bool(__fastcall*)(uintptr_t, AFortPawn*, Vector3)>(ue::cached::signatures::LineOfSightTo);
		
		return LOSTo((uintptr_t)this, Actor, Vector3(0, 0, 0));
	}
	...
	bool WasInputKeyJustReleased(const struct ue::FKey& Key)
	{
		static ue::classes::UObject* fn = NULL;
		if (!fn)
			fn = (ue::classes::UObject*)find::FindObject((L"Engine.PlayerController.WasInputKeyJustReleased"));
...
public:
	...
	ULevel* GetWorldSettings()
	{
		if (!sdkUssage->isValidPointer((uintptr_t)this)) return 0;
		uintptr_t result;

		sdkUssage->ProcessEvent((uintptr_t)this, ue::cached::objects::K2_GetWorldSettings, &result);

		return (ULevel*)result;
	}
};
